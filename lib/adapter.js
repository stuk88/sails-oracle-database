...
module.exports = (function() {
    ...
    var adapter = {
        ...
        registerDatastore: function(connection, collections, cb) {
            ...
            if (datastores[connection.identity])
        ...
        define: function(connectionName, collectionName, definition, cb) {
            ...
            // Run query
            execQuery(datastores[connectionName], query, [], function __DEFINE__(err, result) {
                if (err) {
    ...
    function _getPK(connectionName, collectionName) {
        ...
        try {
            collectionDefinition = datastores[connectionName].collections[collectionName].definition;
            var pk;
